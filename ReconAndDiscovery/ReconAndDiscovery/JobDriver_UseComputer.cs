		...
		private sealed class <MakeNewToils>c__Iterator0 : IEnumerable, IEnumerable<Toil>, IEnumerator, IDisposable, IEnumerator<Toil>
		{
			...
			public bool MoveNext()
			{
				...
				case 1U:
				{
					...
					{
						base.Computer.GetComp<CompComputerTerminal>().actionDef.ActivatedAction.TryAction(base.GetActor(), base.GetActor().Map, null);
					};
					this.$current = toil;
					if (!this.$disposing)
					{
			...
			IEnumerator<Toil> IEnumerable<Toil>.GetEnumerator()
			{
				...
				JobDriver_UseComputer.<MakeNewToils>c__Iterator0 <MakeNewToils>c__Iterator = new JobDriver_UseComputer.<MakeNewToils>c__Iterator0();
			...
			internal JobDriver_UseComputer $this;
